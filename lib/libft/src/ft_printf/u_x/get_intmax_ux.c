...
/*   Updated: 2024/10/31 16:15:28 by mde-beer       ########   odam.nl        */
/*                                                                            */
/* ************************************************************************** */
...
static t_uchar	*pf_itoa(uintmax_t value, t_printf_arg *argument,
							t_uint numwidth)
{
	t_uchar	*out;
	t_uint	outlen;
...
static t_uint	get_len(uintmax_t value)
{
	t_uint	width;
