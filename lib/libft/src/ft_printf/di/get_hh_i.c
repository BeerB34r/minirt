...
/*   Updated: 2024/10/31 13:02:00 by mde-beer       ########   odam.nl        */
/*                                                                            */
/* ************************************************************************** */
...
static t_schar	pf_abs(t_schar value)
{
	return (value * (value >= 0) + -value * (value < 0));
}

static void	put_array(t_uchar *out, t_uint index, t_schar value, char *radix)
{
...
static t_uchar	*pf_itoa(t_schar value, t_printf_arg *argument, t_uint numwidth)
{
	t_uchar	*out;
	t_uint	outlen;
...
static t_uint	get_len(t_schar value)
{
	t_uint	width;
