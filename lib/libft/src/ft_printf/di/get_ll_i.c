...
/*   Updated: 2024/10/31 13:02:49 by mde-beer       ########   odam.nl        */
/*                                                                            */
/* ************************************************************************** */
...
static t_uchar	*pf_itoa(t_ll_sint value, t_printf_arg *argument,
							t_uint numwidth)
{
	t_uchar	*out;
	t_uint	outlen;
...
static t_uint	get_len(t_ll_sint value)
{
	t_uint	width;
