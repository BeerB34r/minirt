...
/*   Updated: 2025/12/11 15:51:23 by alkuijte      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (t
		- ((sq_h1_io(l_t(lw, t), s) - 1)
			/ sq_h1_derivative(sq_wl_ol(lw, s), l_t(sq_wl_ol(lw, s), t), s)));
}
...
)
{
	...
	while (++i < MAX_NEWTON_ITER)
	{
		...
		if (approx(sq_h1_io(l_t(lw, f_t), s)) == 1)
		{
			*t = f_t;
			return (1);
		}
