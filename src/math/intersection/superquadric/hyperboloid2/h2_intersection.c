...
/*   Updated: 2025/12/11 15:51:12 by alkuijte      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (t
		- ((sq_h2_io(l_t(lw, t), s) - 1)
			/ sq_h2_derivative(sq_wl_ol(lw, s), l_t(sq_wl_ol(lw, s), t), s)));
}
...
int	sq_h2_int(t_line lw, struct s_rt_element_superquadric s,
	double *t)
{
	size_t			i;
	double			f_t;
