...
)
{
	...
	if (count_fields(element_fields) != SUPERQUADRIC_FIELDS + 1)
		...
		&& !get_real(element_fields[2], &result.r)
		&& !get_real(element_fields[3], &result.s)
		&& !get_real(element_fields[4], &result.t)
		&& !get_real(element_fields[5], &result.a)
		&& !get_real(element_fields[6], &result.b)
		&& !get_real(element_fields[7], &result.c)
		&& !get_rgba(element_fields[8], &result.color)
	)
	{
